...
def main() :
    ...
    #    contours = contours.astype(np.float)
        ...
        servo_angle, thruster_value = markDetection_0716.move_with_largest(contour_info, raw_image.shape[1]) # return : servo, thruster

        docking.publish_value(servo_angle,thruster_value)
        #rospy.spin()
